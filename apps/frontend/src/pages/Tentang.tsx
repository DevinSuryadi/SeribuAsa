        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div ref={heroRef} className="text-center mb-14 md:mb-20">
            ...
            <p className="mt-4 text-sm sm:text-base text-gray-400 max-w-md mx-auto leading-relaxed">
              Platform digital yang memastikan setiap keluarga Indonesia mendapat akses pangan
              bergizi yang layak dan terukur.
            </p>
          </div>
          ...
          <div
            ref={missionRef}
            className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 max-w-3xl mx-auto mb-16 md:mb-20"
          >
            {values.map((item) => (
              <div
                key={item.title}
            ...
            <div className="flex flex-col gap-2">
              {faqs.map((faq, i) => {
                ...
                return (
                  <div
                    key={key}
                    className="rounded-xl border border-gray-100 bg-white/85 backdrop-blur-md overflow-hidden"
                  >
                    <button
