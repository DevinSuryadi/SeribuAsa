                ...
                <div className="rounded-lg border border-accent/30 bg-accent/5 p-4 flex items-start gap-3 text-left">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground">
                      Berdasarkan skor FIES Anda, alokasi voucher nutrisi akan diprioritaskan untuk
                      keluarga Anda.
                    </p>
                  </div>
                </div>
    ...
    return (
      <DashboardLayout title="Survei FIES" subtitle="Survei ketahanan pangan bulanan.">
        <div className="max-w-lg mx-auto space-y-6">
          ...
          <Card>
            <CardHeader>
              <CardTitle className="text-sm">Riwayat Survei</CardTitle>
            </CardHeader>
            <CardContent>
              {historyLoading ? (
