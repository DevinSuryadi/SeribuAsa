            ...
            <div className="ml-auto flex gap-2">
              ...
              >
                <Link to="/dashboard/orders">
                  <QrCode className="h-3.5 w-3.5" aria-hidden="true" /> QR Pickup
                </Link>
              </Button>
            </div>
          </div>
                  ...
                  <div key={alloc.id} className="p-4">
                    <div className="flex items-center justify-between mb-2">
                      <div>
                        ...
                        <p
                          className={`text-[11px] mt-0.5 ${isExpiringSoon ? "text-amber-600 font-semibold" : "text-muted-foreground"}`}
                        >
                          {isExpiringSoon && "⚠️ "}
                    ...
                    <div className="h-1.5 bg-slate-100 rounded-full overflow-hidden">
                      <div
                        className={`h-full rounded-full transition-[width] duration-500 ${isExpiringSoon ? "bg-amber-400" : "bg-emerald-500"}`}
                        style={{ width: `${pct}%` }}
                      />
                    </div>
                  </div>
                  ...
                  return (
                    ...
                    >
                      <div className="flex items-center gap-3">
                        <div
                          className={`flex h-9 w-9 items-center justify-center rounded-full flex-shrink-0 ${cfg.bg}`}
                        >
                      ...
                      <div className="text-right">
                        <div
                          className={`text-sm font-bold ${cfg.isIn ? "text-emerald-600" : "text-foreground"}`}
                        >
                          {cfg.isIn ? "+" : "-"}
